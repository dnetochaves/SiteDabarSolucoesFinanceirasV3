...
// PRD §5.1: CTA final → WhatsApp
// PRD §8.2: CTA band final → bg #1A1A1A · text #FFFFFF · sub #777777
...
export default function CTAFinal() {
  ...
  return (
    <section className="bg-brand-dark py-20" aria-labelledby="cta-final-heading">
